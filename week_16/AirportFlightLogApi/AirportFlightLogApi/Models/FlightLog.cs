...
namespace AirportFlightLogApi.Models
{
    public class FlightLog
    {
        ...
        [Required(ErrorMessage = "Flight number is requird")]
        ...
        [StringLength(50, ErrorMessage = "Airline name cannot exceed 50" +
            "characters")]
        ...
        [StringLength(100, ErrorMessage =
            "Destination cannot exceed 100 characters")]
        public string Destination { get; set; } = string.Empty;

        [Range(1, 1000, ErrorMessage = "Passenger count must be" +
            "between 1 and 1000")]
